...
// const prompt="Generate a Solidity-based NFT marketplace contract along with its necessary configuration, deployment script, and environment file. The response should be in **JSON format**, where each file is represented as an object with a `filename` key and a `content` key containing the respective code.  
